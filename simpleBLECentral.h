...
//additional event definition youjia
#define BTN1_LONGPRESS_EVT                            0x0004
#define T1_TIMEOUT                                    0x0008
  
#define PER_DISC_EVT                                  0x0010
#define RSP_PAIRNUM_EVT                               0x0020
  
#define BTN2_EVT                                      0x0040
  
  
#define PAIR_HOLDING_TIME                            3000//in ms
  
#define DEVICE_MODE_IDLE                                   0x00
#define DEVICE_MODE_TRCING                                 0x01
#define DEVICE_MODE_ALARM                                  0x02
/*********************************************************************
 * MACROS
 */
